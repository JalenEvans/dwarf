 ...
 * @returns {string}
 */
function compile(source, filename, options_json) {
    let deferred4_0;
    let deferred4_1;
    try {
 ...
 * @returns {string}
 */
function compile_simple(source, filename) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ptr1 = passStringToWasm0(filename, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.compile_simple(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
exports.compile_simple = compile_simple;
...
const wasmPath = `${__dirname}/dwarf_wasm_bg.wasm`;
