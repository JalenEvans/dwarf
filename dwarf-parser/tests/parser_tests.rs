...
fn test_dwarf116_integration_test_decorator_on_function() {
    ...
    match &decls[0] {
        ...
        other => panic!("Expected Decl::Function with decorators, got {:?}", other),
    }
}
...
fn test_parse_type_implements_single_interface() {
    ...
    match &decls[0] {
        Decl::RecordDef {
            ...
            assert_eq!(implements.len(), 1, "Should implement one interface");
...
fn test_parse_type_implements_multiple_interfaces() {
    ...
    match &decls[0] {
        Decl::RecordDef {
            ...
            assert_eq!(implements.len(), 2, "Should implement two interfaces");
